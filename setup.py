...
setup(
    ...
    url=about['__url__'],
    packages=['pyfi', 'pyfi.tests', 'pyfi.util', 'pyfi.yaml', 'pyfi.client.user', 'pyfi.config', 'pyfi.client.example', 'pyfi.client.example.api', 'pyfi.client', 'pyfi.api', 'pyfi.api.resource', 'pyfi.api.resource.dto',
